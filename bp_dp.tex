...
The development of PIN detector for MS spectroscopy can continue by employing the photodiodes with better detection efficiency, which could be achieved by using photodiode with greater thickness or by using different material with higher Z (for example Ge). To fully observe 6.4 keV photon peak on S14605 Si PIN, it will be necessary to employ a photodiode with lesser capacitance (greater thickness also impies lesser capacitance) or a preamplifier with a better characteristics.
